...
<table class="table table-hover table-bordered">
	...
	<tr>
		...
		<th>Image</th>
		<th>
			<a href="{{ route('type_cate.add') }}" class="btn btn-success">
	...
	@foreach($type_cate as $element)
		<tr>
			...
			<td>
				<a href="{{ route('type_cate.edit', ['id' => $element->id]) }}" title="" class="btn btn-sm btn-primary">
					<i class="fa fa-pencil"></i>
				</a>
				<a href="javascript:;" onclick="confirmRemove('{{ route('type_cate.remove', ['id' => $element->id]) }}')" title="" class="btn btn-sm btn-danger">
