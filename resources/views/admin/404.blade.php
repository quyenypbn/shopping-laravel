...
<link href="{{asset('quantri/admin/pages/css/error.css')}}" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="{{asset('quantri/admin/layout/css/themes/darkblue.css')}}" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="{{asset('quantri/admin/pages/media/pages/earth.jpg')}}" class="img-responsive" alt="">
</div>
